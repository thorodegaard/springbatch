package com.thor.spring.batch.helloworld;
...
public class HelloWorldAppMain {

    static Job jobObj;
    static JobLauncher jobLauncherObj;
    static ApplicationContext contextObj;
    private static String[] springConfig  = {"spring/batch/jobs/helloworld-job-spring-context.xml"};
